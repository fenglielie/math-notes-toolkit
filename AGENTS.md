...
- Maintain SYNTAX.md, examples/, styles/, and core tests here. Extension copies of examples and highlight CSS are generated; link to the root syntax reference instead of copying it into the extension.

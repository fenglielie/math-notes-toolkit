...
- Maintain SYNTAX.md, examples/, styles/, and core tests here. Generate extension copies of the syntax reference, examples, and highlight CSS so VSIX documentation works offline; do not edit generated copies.
